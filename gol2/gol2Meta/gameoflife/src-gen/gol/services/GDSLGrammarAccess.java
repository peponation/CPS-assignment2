...
public class GDSLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Model");
	...
	public class GOLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.GOL");
	...
	public class RulesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Rules");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Rule");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GridElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Grid");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CellElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Cell");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StateElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.State");
	...
	public class CompareElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "gol.GDSL.Compare");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("gol.GDSL".equals(grammar.getName())) {
				return grammar;
			}
